                ...
                <div class="space-y-2 border-t-2 border-[#3a2016] pt-3 text-xs mb-3">
                    ...
                    <div class="flex justify-between items-center bg-[#3a2016] text-white p-4 rounded-xl shadow-md mt-2 relative">
                        <div class="flex flex-col gap-1">
                            ...
                            <div v-else-if="invoice.paymentStatus === 'الدفع عند الاستلام'" class="flex items-center gap-1.5 bg-blue-500/20 text-blue-200 px-2 py-0.5 rounded-md border border-blue-400/50 w-fit">
